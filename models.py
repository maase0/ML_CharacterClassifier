...
def get_M9(num_classes):
    ...
    model = tf.keras.models.Sequential([
        tf.keras.layers.Conv2D(input_shape=(63, 64, 1), kernel_size=3, activation='relu', filters=64, name="conv2D_1_1_input"),
        tf.keras.layers.MaxPool2D(pool_size=(2, 2), strides=2, name="maxpool_1"),
        ...
        #set the dtype to float32 for numerical stability
        tf.keras.layers.Softmax(dtype="float32", name="softmax_output") 
    ], name="M9")
